...
The current registry has one production-approved evidence source: the exact pinned Tanzil Quran Text v1.1 Uthmani snapshot. Other Quran gloss, morphology, Hadith, font, timing, translation, and audio-metadata candidates remain non-production until they independently pass the same gate.
