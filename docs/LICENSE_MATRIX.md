...
| HadeethEnc Arabic | Hadith research candidate | **research-candidate** | Official version check reports Arabic v1.7.0, but the exact artifact plus edition/collection/numbering provenance and applicable preserved terms are still required before Evidence Plane promotion. |
