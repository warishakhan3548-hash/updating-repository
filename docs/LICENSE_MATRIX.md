...
| QuranEnc Arabic Meanings of Words (As-Siraj) v1.0.0 | contextual difficult-word gloss candidate | **awaiting-licence** | Exact review-only source bytes are now preserved at `source-vault/quran-gloss/quranenc/arabic-seraj/1.0.0/`: 114 Surah API responses / 6,236 coordinates, source/index pages, terms, provenance and checksums. The snapshot-manifest SHA-256 is `8cbc4f5f41298e438f7862fff1eba309ffdab254ca240257bd5b652631f2396c`; the preserved terms SHA-256 is `24dd28bc25f21e59a2ec87137faeb0d969c1401232d99d2177cabf887c48341c`. It is **not** registered as a production vault artifact. QuranEnc requires downstream copies to track the latest issued version, while indefinite public retention of superseded snapshots is not clearly established by the inspected terms. Production promotion therefore remains blocked pending archival-rights clarification; freshness review remains a separate later release gate. |
