...
| QuranEnc Arabic Meanings of Words (As-Siraj) v1.0.0 | contextual difficult-word gloss candidate | **awaiting-licence; review snapshot captured** | Exact current-version source/index, terms, provenance, API manifest and 114 Surah response files are preserved under project control and verified offline. Published republication conditions include no modification, attribution/version identification and updating to the latest issued version. The inspected terms do not clearly establish indefinite public retention of superseded editions, so historical archival rights remain unresolved and production promotion is blocked. It is a gloss source, not a morphology or Quran-text authority. |
