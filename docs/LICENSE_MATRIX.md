...
|---|---|---|---|
| Tanzil Quran Text v1.1 | Quran Evidence Plane source | **production-approved** | Exact Uthmani `txt-2` snapshot is preserved in Source Vault. Official terms allow verbatim copying/distribution with attribution/source link and prohibit changing the Quran text; historical snapshot retention is explicitly recorded as verified-allowed and no latest-version release obligation is imposed. |
...
| HadeethEnc Arabic | Hadith research candidate | **research-candidate** | Official version check currently reports Arabic v1.7.0 and republication terms include an ongoing update obligation. Historical retention is therefore recorded as unresolved; no capture or Evidence Plane promotion is permitted until that durability question and edition/collection/numbering provenance are cleared. |
