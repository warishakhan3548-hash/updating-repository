...
| HadeethEnc Arabic | Hadith research candidate | **awaiting-licence** | Official Arabic v1.7.0 is visible, but republication terms require downstream copies to track newer source versions. Indefinite public retention of superseded immutable snapshots is not yet clearly granted, so no bytes may be captured or mirrored. Edition/collection/numbering and grade provenance remain separate Evidence Plane gates. |
