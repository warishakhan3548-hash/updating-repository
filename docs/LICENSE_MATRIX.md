...
MASAQ v5, EQTB v1, QUL-derived candidates, QAC, QuranEnc/HadeethEnc candidates, and QAMAR remain explicitly unresolved where component or downstream rights are not sufficiently established. Tanzil and the current QuranMorph capture candidate are recorded as reviewed clear for this gate; all other existing licence, provenance, artifact, coordinate-alignment and release-time freshness gates still apply.
