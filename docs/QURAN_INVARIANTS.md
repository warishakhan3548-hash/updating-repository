...
- attribution notices must preserve real line structure from the pinned source artifact;
...
- changing this trust contract requires a new immutable content version.
