...
- generic `sha256-set` Source Vault support for immutable multi-file upstream snapshots, with member hash verification and path/symlink containment; this is an integrity primitive only and does not promote any candidate source;
