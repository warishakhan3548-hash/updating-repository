...
- Android runtime verification of pack byte size/SHA-256 plus schema-v2 source metadata before read-only SQLite access;
- candidate Quran pack restricted to Android debug builds; release is disabled until cryptographic approval is genuinely possible;
