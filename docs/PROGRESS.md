...
- universal archival-retention gate: capture-ready, preserved and production sources must explicitly prove durable historical retention; release freshness remains separate from immutable acquisition provenance;
