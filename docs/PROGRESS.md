...
- primary-source audit identified QuranEnc `arabic_seraj` v1.0.0 as a promising verse-scoped difficult-word gloss source and defined a fail-closed gloss bridge that does not fabricate morphology or lexical IDs; a review-only snapshot is preserved, while the registry is `awaiting-licence` because indefinite historical public-mirror rights remain unresolved.
- review-only QuranEnc capture is now preserved at `source-vault/quran-gloss/quranenc/arabic-seraj/1.0.0/`: exact 114 Surah response byte streams / 6,236 coordinates plus source/index pages, terms, provenance and checksums. Snapshot-manifest SHA-256: `8cbc4f5f41298e438f7862fff1eba309ffdab254ca240257bd5b652631f2396c`; terms SHA-256: `24dd28bc25f21e59a2ec87137faeb0d969c1401232d99d2177cabf887c48341c`. It remains unregistered for production use.
...
- QuranEnc Arabic Meanings of Words (As-Siraj) v1.0.0: `awaiting-licence`; exact review-only bytes are preserved, but the registry intentionally leaves production artifact/provenance fields unset because long-term public retention of superseded versions is not yet clearly authorized.
...
4. Resolve QuranEnc archival-retention rights before any production promotion. The exact review-only v1.0.0 snapshot already exists; keep it outside production until explicit permission or another legally durable design establishes whether superseded snapshots may remain publicly archived. If cleared, bind the exact candidate into the registry, revalidate it, then build the verse-scoped gloss pack without inferring morphology or lexical IDs.
