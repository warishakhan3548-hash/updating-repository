...
5. Obtain QuranMorph through an authorized publisher path and verify its exact artifact, licence snapshot, checksum, and 6,236-ayah coordinate alignment; keep QAC/QUL blocked unless their own gates clear. Resolve HadeethEnc historical-snapshot retention rights (or select another legally durable edition-aware Hadith source) before preserving Hadith bytes or building production Hadith search.
