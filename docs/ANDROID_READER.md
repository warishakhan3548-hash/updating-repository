...
The Android build points its asset source directly at `content-packs/quran-core/1.1.0/`; no second Quran database is committed. This is the canonical-bound schema-v3 candidate generated from the preserved Tanzil snapshot.
