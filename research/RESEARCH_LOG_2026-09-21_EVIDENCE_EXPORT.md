...
| fact | The current mainline documents the evidence-export/verify-back trust boundary but still has no executable implementation owner for either. | repository audit replayed on current main `57fff58de2bb69d5fcf6e944bc6f232f51a160d9` | 2026-09-21 | High | Implement one deterministic owner rather than adding another architecture-only document or parallel evidence database. |
