...
| fact | QuranEnc permits republication subject to conditions that include updating republished content according to the latest issued version. | https://quranenc.com/en/home/api | 2026-09-21 | High | Current-version republication does not by itself prove indefinite public retention of superseded snapshots; keep arabic_seraj blocked until archival retention is clarified. |
| fact | HadeethEnc's published republication conditions likewise include updating according to the latest issued version. | https://hadeethenc.com/en | 2026-09-21 | High | Do not promote HadeethEnc into the immutable Hadith Evidence Plane until historical-retention rights and edition/numbering provenance are separately cleared. |
| inference | “May redistribute” and “may keep every historical version publicly mirrored indefinitely” are distinct compliance facts. | Sources above + project reproducibility requirement | 2026-09-21 | High | Make historical-retention clearance a universal pre-capture/preservation gate, not a QuranEnc/HadeethEnc-specific exception. |
