...
| fact | FSRS scheduling uses a configurable desired-retention target; retrievability is a model output rather than a universal product-level safety threshold. | https://github.com/open-spaced-repetition/py-fsrs | 2026-09-21 | High | Keep due-review deferral inside the scheduler adapter instead of imposing a global 0.60 floor in the rescue policy. |
...
- Optional retrievability can inform ranking/diagnostics without becoming a universal substitution threshold.
