...
def validate_manifest(manifest_path: Path, registry_path: Path) -> None:
    ...
    # Authenticity is the final promotion gate. Quran source/provenance,
    # canonical binding and semantic fidelity are proven first, so a valid
    # signature can never legitimize altered sacred evidence.
