...
public final class SearchIntentChecks {
    ...
    public static void main(String[] args)throws Exception{
        ...
        UnifiedQuery longQuran=UnifiedQuery.parse(longFreeText,UnifiedQuery.QURAN);
        UnifiedQuery longHadith=UnifiedQuery.parse(longFreeText,UnifiedQuery.HADITH);
        check(longQuran.quran&&!longQuran.hadith,"Long text respects Quran-only scope");
        check(!longHadith.quran&&longHadith.hadith,"Long text respects Hadith-only scope");
