...
class _SearchScreenState extends State<SearchScreen> {
  ...
  void _setBulkQuery(String value) {
    ...
    _resetBrowseWindow();
    setState(() {
      // Keep large pasted lists out of EditableText. A 30k-character invoice
      // laid out in the single-line search field can make cursor/layout work
      // noticeably expensive on ordinary Android phones; search still receives
      // the complete list through the dedicated query state below.
      _query.clear();
      _bulkQuery = value;
      _scan = null;
      _clearCatalog();
