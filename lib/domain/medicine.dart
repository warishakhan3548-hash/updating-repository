...
String normalizeForm(String raw) {
  ...
  const aliases = {
    ...
    'mouth dissolving tablet': 'Tablet',
    'mouth dissolving tablets': 'Tablet',
    ...
    'enteric coated tablets': 'Tablet',
    'enteric-coated tablet': 'Tablet',
    'enteric-coated tablets': 'Tablet',
    'sustained release tablet': 'Tablet',
    'sustained release tablets': 'Tablet',
    'extended release tablet': 'Tablet',
    'extended release tablets': 'Tablet',
    'controlled release tablet': 'Tablet',
    'controlled release tablets': 'Tablet',
    'sr tablet': 'Tablet',
    'sr tablets': 'Tablet',
    'er tablet': 'Tablet',
    'er tablets': 'Tablet',
