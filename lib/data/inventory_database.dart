...
class InventorySnapshot {
  InventorySnapshot({
    ...
    this.unknownSold = 0,
       ...
       events = _freezeInventoryEvents(events ?? const <Map<String, dynamic>>[]),
...
bool _canCaptureUndoSnapshot(
  ...
  // before materializing large ID sets: building a 100k-row before-image only
  // to discover the 256-row cap causes avoidable memory pressure and jank.
  final touchedRows =
