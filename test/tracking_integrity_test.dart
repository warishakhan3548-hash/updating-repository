  ...
  group('reorder evidence integrity', () {
    ...
    test(
      ...
      () {
        ...
        expect(stats.reorder.single.suggestedQuantity, isNull);
    ...
    test(
      'genuine SOLD history preserves price but cannot invent future demand',
      () {
        final stats = TrackingStats(
          medicines: [
            _medicine(
    ...
    test('matching immutable sale identity still powers reorder velocity', () {
      ...
      expect(suggestion.unitsPerDay, greaterThan(0));
