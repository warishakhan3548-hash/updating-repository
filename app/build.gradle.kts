...
android {
    ...
    defaultConfig {
        ...
        // Release readiness is a verified trust decision, not a string-shape check.
        // Until the project has a trusted-key cryptographic verifier wired into the
        // Android release path, every non-debug runtime remains fail-closed.
    ...
    doLast {
        ...
        error(
            "Release build blocked: trusted-key cryptographic content-pack signature " +
                "verification is not implemented in the Android release path"
        )
    }
}
