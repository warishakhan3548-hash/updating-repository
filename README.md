...
**Not production-approved yet:** QuranEnc Arabic difficult-word glosses, Quranic Arabic Corpus/QuranMorph/QUL morphology, Hadith datasets and other optional content. The exact QuranEnc `arabic_seraj` v1.0.0 review snapshot is now preserved and verified offline, but production use remains blocked by unresolved historical archival-retention rights. See `source-vault/registry.json`.
