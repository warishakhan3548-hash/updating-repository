...
Approved content packs require real Ed25519 verification against the project trusted public-key policy after source/provenance and semantic checks. No production release key is enrolled yet, so `quran-core 1.0.4` remains an unsigned candidate rather than being cosmetically promoted.
