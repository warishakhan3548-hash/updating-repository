...
**Not production-approved yet:** QuranEnc Arabic difficult-word glosses (`awaiting-licence`: historical public-mirror retention is unresolved), Quranic Arabic Corpus/QuranMorph/QUL morphology, Hadith datasets and other optional content. See `source-vault/registry.json`.
