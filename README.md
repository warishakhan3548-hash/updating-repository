...
**Not production-approved yet:** QuranEnc Arabic difficult-word glosses, Quranic Arabic Corpus morphology, Hadith datasets, QUL resources and other optional content. See `source-vault/registry.json`.
