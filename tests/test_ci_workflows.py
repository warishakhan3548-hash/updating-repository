...
class WorkflowSupplyChainTests(unittest.TestCase):
    ...
    def test_release_verification_dependency_is_exactly_pinned(self) -> None:
        active = [
            line.strip()
    ...
    def test_foundation_validates_trust_root_before_pack_gate(self) -> None:
        workflow = self.workflow_text("foundation.yml")
        policy = "python tools/pack_signatures.py policy/trusted_pack_keys.json"
