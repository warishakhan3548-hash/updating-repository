...
PACKAGED_REPOSITORY = ROOT / "app" / "src" / "main" / "java" / "com" / "aaris" / "quran" / "data" / "PackagedQuranRepository.kt"
...
class AndroidReaderTrustTests(unittest.TestCase):
    ...
    def test_release_runtime_persists_monotonic_sequence_outside_backup(self):
        ...
        self.assertIn("MAX_SIGNED_SEQUENCE = 9_007_199_254_740_991L", guard)
